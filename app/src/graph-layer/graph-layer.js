...
export default class GraphLayer extends CompositeLayer {
  ...
  updateState({ props, oldProps, changeFlags }) {
    const dataChanged =
      changeFlags.dataChanged || changeFlags.updateTriggersChanged;
    const {
      attributes,
      shortestPathTransform,
      nodeAttributesTransform,
      edgeAttributesTransform,
    } = this.state;
      ...
      for (const attributeName in attributes) {
        ...
        if (
          ...
          (changeFlags.updateTriggersChanged &&
            changeFlags.updateTriggersChanged[attribute.userData.accessor])
        ) {
    ...
    return [
      new EdgeLayer(
        this.getSubLayerProps({
          ...
          instanceSourcePositions:
            edgeAttributesTransform.sourcePositionsBuffer,
          instanceTargetPositions:
            edgeAttributesTransform.targetPositionsBuffer,
      ...
      new ScatterplotLayer(
        this.getSubLayerProps({
          ...
          instancePositions: {
            buffer: nodeAttributesTransform.nodePositionsBuffer,
            size: 4,
          },
